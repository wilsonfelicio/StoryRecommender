    ...
    return (
      <div className="px-5 pb-8 pt-6">
        <button
          ...
          className="inline-flex items-center gap-1.5 text-sm font-semibold text-violet-400 mb-6 hover:gap-2.5 transition-all duration-200"
        >
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-extrabold bg-gradient-to-r from-violet-400 via-indigo-400 to-purple-400 bg-clip-text text-transparent">
            {selected.title}
          </h2>
        ...
        <div className="glass rounded-3xl p-6 space-y-4">
          {paragraphs.map((p, i) => (
            <p
              key={i}
              className="text-[17px] leading-8 text-gray-200 font-serif select-text"
            >
              {p}
            </p>
          ))}
        ...
        <div className="flex justify-center mt-6">
          <button
            ...
            className="px-6 py-3 rounded-2xl bg-rose-500/10 text-rose-400 text-sm font-semibold hover:bg-rose-500/20 active:scale-[0.98] transition-all duration-200"
          >
            🗑 Delete Story
          </button>
        </div>
      ...
      {stories.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 text-center">
          <div className="glass rounded-3xl p-10 inline-flex flex-col items-center">
            <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-gray-700 to-gray-800 flex items-center justify-center mb-5">
          ...
          {stories.map((story) => (
            ...
            >
              ...
              <button
                ...
                className="text-gray-400 hover:text-rose-500 transition-all duration-200 text-sm p-1.5 rounded-lg hover:bg-rose-500/10"
                title="Delete"
              >
                🗑
              </button>
